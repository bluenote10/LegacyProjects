...
class MainFrame(wx.Frame):
    def __init__(self):
        ...
        self.menuAdd(testmenu, "testitem\tCtrl+Meta+Y\tAlt+Meta+3\tShift+Meta+B", "testdesc", StatusUpdater(self, "hello!"))
    ...
    def menuAddM(self, parent, menu, name, help=''):
        if isinstance(parent, wx.Menu) or isinstance(parent, wx.Menu):
            id = wx.NewId()
